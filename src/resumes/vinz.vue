      ...
      <div v-if="person.skills"
        ...
        <div class="section-content-grid">
          <a v-for="(skill, index) in person.skills" :key="index"
            ...
            <span v-if="skill.level >= 95" class="squarred-grid-item skill-master"> {{ skill.name }} </span>
            <span v-if="skill.level >=70 && skill.level < 95" class="squarred-grid-item skill-advanced"> {{ skill.name }} </span>
            <span v-if="skill.level >=50 && skill.level < 70" class="squarred-grid-item skill-intermediate"> {{ skill.name }} </span>
            <span v-if="skill.level < 50" class="squarred-grid-item skill-beginner"> {{ skill.name }} </span>
          </a>
        </div>
      </div>
...
.skill-advanced {
  background-color: @skill-advanced-color;
}
...
.skill-beginner {
  background-color: @skill-beginner-color;
}
